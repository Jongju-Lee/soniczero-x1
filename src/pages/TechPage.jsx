  ...
  return (
    <section className="tech" ref={containerRef}>
      <div className="tech__inner">
        ...
        <section className="tech__anc-section">
          {/* Intro Text */}
          <header className="tech__anc-intro tech-fade-up">
          ...
          <section className="tech__anc-widget tech-fade-up">
            <div className="tech__anc-panel">
              <div className="tech__anc-monitor-header">
                <div className="tech__anc-status-wrapper">
                  <h3 className="tech__anc-monitor-title">Sound Wave Monitor</h3>
                  <p className="tech__anc-monitor-subtitle">
